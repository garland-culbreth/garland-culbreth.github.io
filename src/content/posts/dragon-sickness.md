...
tags:
  - science
description:
  There is value in science for its own sake
---

Under a discussion of [DeepMind's new WeatherNext forecasting model](https://deepmind.google/blog/weathernext-ai-model-achieves-breakthrough-in-forecasting-cyclones/), this exchange astonished me:

```txt
A 2 hours ago | prev | next [–]
And this is why GDM has to go. It's crazy that when Google is struggling so
badly that efforts like this that have no path to revenue at all were funded.
GDM management really thought that they were some kind of charity. UNREAL.
reply
    B 1 hour ago | parent | next [–]
    Are you being sarcastic? Even if “Google is struggling so badly” (which it
    really is not - the narrative will flip again at some point), these efforts
    will have a lasting impact on the world. Not everything good is about
    bringing in revenue.
    reply
        C 39 minutes ago | root | parent | next [–]
        shareholders are pretty unhappy about demis. think about alphafold. huge
        investments from the company, tens of billions. at a critical time. and
        absolutely 0 revenue. it got demis a nobel though. as a shareholder
        you'd be unhappy too.
        reply
    C 41 minutes ago | parent | prev | next [–]
...
Cherry might have been writing about A and C today.

With the news that Hassabis is leaving Google DeepMind to become Google's chief scientist there's anxiety about DeepMind's future. I hope they're able to keep working on science for its own sake. The world is better for it when scientists aren't so bound the wheel of a conventional life.
\
\
\
P.S. Cherry-Gerrard's book, [_The Worst Journey in the World_](https://www.gutenberg.org/files/14363/14363-h/14363-h.htm), is amazing. Considered one of the best travel-adventure books ever written, it tells of how he and two companions, who would later die with Scott on their return from the pole, risk their lives a hundred times a day for six weeks on the first ever winter journey in Antarctica seeking scientific knowledge ultimately proved futile. It asks deep questions about science, life, and meaning, and leaves the answers up to you. It's well worth the read if you haven't already.
